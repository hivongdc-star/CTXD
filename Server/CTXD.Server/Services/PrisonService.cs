...
public sealed record PrisonTrialResult(bool Upgraded,int LashLv,int EffectiveLashLv,int Gold,DateTimeOffset? TrialEndsAt);
...
public sealed partial class PrisonService
{
    ...
    readonly SlaveActivityService slaveActivity;
    ...
    public PrisonService(GameDb db,CanonicalContent content,IPlayerItemInventory items,ExperienceService experience,TechnologyEffectService technologies,DstqActivityService dstq,SlaveActivityService slaveActivity,GamePushHub push)
    {
        this.db=db;this.content=content;this.items=items;this.experience=experience;this.technologies=technologies;this.dstq=dstq;this.slaveActivity=slaveActivity;this.push=push;
